<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="PaperWidthManagement.aspx.cs" Inherits="PrintingProject.PaperWidthManagement" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="sectioncontent">
        <table>
            <tr>
                <td>
                    <img src="Images/menu/Submenu/ruler_pencil.png" />
                </td>
                <td>
                    <br />
                    اضافه کردن عرض کاغذ
    ...
    <div class="sectioncontent">
        <asp:GridView ID="grdviewPaperWidth" runat="server" AutoGenerateColumns="False"  ShowHeaderWhenEmpty="True" EmptyDataText="رکوردی موجود نیست."
            CellPadding="4" AllowPaging="True" PageSize="10" Width="100%" 
            onpageindexchanging="grdviewPaperWidth_PageIndexChanging" 
