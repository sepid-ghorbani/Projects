<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="ProductionOrderManagement.aspx.cs" Inherits="PrintingProject.ProductionOrderManagement" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
       ...
       <table width="100%">
        ...
        <div class="boxgray">
            <table width="100%">
                <tr>
                    ...
                    <td style="width: 100px;">
                        <asp:HyperLink ID="HyperProductionOrder" runat="server" BackColor="#99CCFF">سفارش تولید</asp:HyperLink>
                    </td>
                    <td style="width: 100px;">
        ...
        <table style="padding: 10px">
            ...
            <tr>
                ...
                <td>
                    <telerik:RadNumericTextBox runat="server" ID="txtOrderCount" MinValue="0" Skin="Web20">
    ...
    <div class="sectioncontent">
        <asp:GridView ID="grdviewProductionOrder" runat="server" AutoGenerateColumns="False"
            ShowHeaderWhenEmpty="True" EmptyDataText="رکوردی موجود نیست." CellPadding="4"
            AllowPaging="True" PageSize="10" Width="100%" OnPageIndexChanging="grdviewProductionOrder_PageIndexChanging"
            ...
            <Columns>
                ...
                <asp:BoundField DataField="OrderCount" HeaderText="تعداد سفارش">
                    <HeaderStyle HorizontalAlign="Right" />
                    <ItemStyle HorizontalAlign="Right" />
                </asp:BoundField>
                 <asp:BoundField DataField="OrderDatePersian" HeaderText="تاریخ سفارش">
                    <HeaderStyle HorizontalAlign="Right" />
                    <ItemStyle HorizontalAlign="Right" />
                </asp:BoundField>
                <asp:TemplateField>
                ...
                <asp:TemplateField>
                    <ItemTemplate>
                        <asp:HyperLink ImageUrl="Images/printer.png" ID="HyperLink1" runat="server" Target="_blank"
                            NavigateUrl='<%# "PrintPreviewPage.aspx?ProductionOrderId=" + Eval("Id") %>'></asp:HyperLink>
                    </ItemTemplate>
                    <ItemStyle HorizontalAlign="Center" Width="80px" />
                </asp:TemplateField>
            </Columns>
