<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="SahafiManagement.aspx.cs" Inherits="PrintingProject.SahafiManagement" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
      ...
      <table width="100%">
        ...
        <div class="boxgray">
            <table width="100%">
                <tr>
                    ...
                    <td style="width: 100px;">
                        <asp:HyperLink ID="HyperLinkSahafi" runat="server" BackColor="#99CCFF">صحافی</asp:HyperLink>
                    </td>
                    <td style="width: 100px;">
        ...
        <table style="padding: 10px">
            ...
            <tr>
                ...
                <td>
                    <telerik:RadComboBox MarkFirstMatch="True" runat="server" ID="cmbSahafiType" DataTextField="Name"
                        DataValueField="Id" Skin="Office2010Blue">
                    </telerik:RadComboBox>
                    <asp:RequiredFieldValidator runat="server" ErrorMessage="*" ControlToValidate="cmbSahafiType"
                        ValidationGroup="insert" ForeColor="#FF3300"></asp:RequiredFieldValidator>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td>
                    <telerik:RadComboBox MarkFirstMatch="True" runat="server" ID="cmbPocketGlue" Skin="Office2010Blue">
                        <Items>
            ...
            <tr>
                ...
                <td>
                    <telerik:RadNumericTextBox runat="server" ID="txtTextFormCount" MinValue="0" Skin="Web20">
                        <NumberFormat AllowRounding="False" GroupSeparator="," ZeroPattern="n" />
                    </telerik:RadNumericTextBox>
                </td>
            </tr>
            <tr>
                ...
                <td>
                    <telerik:RadNumericTextBox runat="server" ID="txtFormSum" MinValue="0" Skin="Web20">
                        <NumberFormat AllowRounding="False" GroupSeparator="," ZeroPattern="n" />
                    </telerik:RadNumericTextBox>
                </td>
            </tr>
    ...
    <div class="sectioncontent">
        <asp:GridView ID="grdviewSahafi" runat="server" AutoGenerateColumns="False" ShowHeaderWhenEmpty="True"
            EmptyDataText="رکوردی موجود نیست." CellPadding="4" AllowPaging="True" PageSize="10"
            Width="100%" OnPageIndexChanging="grdviewSahafi_PageIndexChanging" GridLines="None"
            ForeColor="#333333">
            ...
            <Columns>
                ...
                <asp:BoundField DataField="SahafiTypeName" HeaderText="نوع صحافی">
                    <HeaderStyle HorizontalAlign="Right" />
                    <ItemStyle HorizontalAlign="Right" />
                </asp:BoundField>
                ...
                <asp:TemplateField>
                    <ItemTemplate>
                        <asp:HyperLink ImageUrl="Images/printer.png" ID="HyperLink1" runat="server" Target="_blank"
                            NavigateUrl='<%# "PrintPreviewPage.aspx?SahafiId=" + Eval("Id") %>'></asp:HyperLink>
                    </ItemTemplate>
                    <ItemStyle HorizontalAlign="Center" Width="80px" />
                </asp:TemplateField>
            </Columns>
