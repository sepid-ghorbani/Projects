<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="SahafiTypesManagement.aspx.cs" Inherits="PrintingProject.SahafiTypesManagement" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="sectioncontent">
        <table>
            <tr>
                <td>
                    <img src="Images/menu/Submenu/phone_book_edit.png" />
                </td>
                <td>
                    <br />
                    اضافه کردن نوع صحافی
                </td>
            </tr>
        </table>
    ...
    <div class="sectioncontent">
        <asp:GridView ID="grdviewSahafiTypes" runat="server" AutoGenerateColumns="False"  ShowHeaderWhenEmpty="True" EmptyDataText="رکوردی موجود نیست."
            CellPadding="4" AllowPaging="True" PageSize="10" Width="100%" 
            onpageindexchanging="grdviewSahafiTypes_PageIndexChanging" 
