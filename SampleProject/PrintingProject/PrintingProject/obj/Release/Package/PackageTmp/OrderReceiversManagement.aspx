<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="OrderReceiversManagement.aspx.cs" Inherits="PrintingProject.OrderReceiversManagement" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="sectioncontent">
        <table>
            <tr>
                <td>
                    <img src="Images/menu/Submenu/open_folder_full.png" />
                </td>
                <td>
                    <br />
                    اضافه کردن سفارش گیرنده جدید
                </td>
            </tr>
        </table>
        <table style="padding: 10px">
            ...
            <tr>
                ...
                <td>
                    <asp:CheckBoxList ID="chkBoxLevels" runat="server" RepeatDirection="Horizontal">
                        <asp:ListItem Value="1">لیتوگرافی</asp:ListItem>
                        <asp:ListItem Value="2">چاپ</asp:ListItem>
                        <asp:ListItem Value="3">خرید کاغذ</asp:ListItem>
                        <asp:ListItem Value="4">روکش</asp:ListItem>
                        <asp:ListItem Value="5">لترپرس</asp:ListItem>
                        <asp:ListItem Value="6">ساخت قالب</asp:ListItem>
                        <asp:ListItem Value="7">صحافی</asp:ListItem>
                        <asp:ListItem Value="8">کارتکس</asp:ListItem>
                    </asp:CheckBoxList>
                </td>
            </tr>
            <tr>
    ...
    <div class="sectioncontent">
        <asp:GridView ID="grdviewOrderReceivers" runat="server" AutoGenerateColumns="False"
            ShowHeaderWhenEmpty="True" EmptyDataText="رکوردی موجود نیست." CellPadding="4"
            AllowPaging="True" PageSize="10" Width="100%" OnPageIndexChanging="grdviewOrderReceivers_PageIndexChanging"
