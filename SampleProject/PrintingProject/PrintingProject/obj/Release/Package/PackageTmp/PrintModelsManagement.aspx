<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="PrintModelsManagement.aspx.cs" Inherits="PrintingProject.PrintModelsManagement" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="sectioncontent">
        <table>
            <tr>
                <td>
                    <img src="Images/menu/Submenu/search_printer.png" />
                </td>
                <td>
                    <br />
                    اضافه کردن مدل چاپ
    ...
    <div class="sectioncontent">
        <asp:GridView ID="grdviewPrintModels" runat="server" AutoGenerateColumns="False"  ShowHeaderWhenEmpty="True" EmptyDataText="رکوردی موجود نیست."
            CellPadding="4" AllowPaging="True" PageSize="10" Width="100%" 
            onpageindexchanging="grdviewPrintModels_PageIndexChanging" 
