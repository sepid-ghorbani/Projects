<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="DimensionsManagement.aspx.cs" Inherits="PrintingProject.DimensionsManagement" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="sectioncontent">
        <table>
            <tr>
                <td>
                    <img src="Images/menu/Submenu/ruler.png" />
                </td>
                <td>
                    <br />
                    اضافه کردن ابعاد 
    ...
    <div class="sectioncontent">
        <asp:GridView ID="grdviewDimensions" runat="server" AutoGenerateColumns="False"  ShowHeaderWhenEmpty="True" EmptyDataText="رکوردی موجود نیست."
            CellPadding="4" AllowPaging="True" PageSize="10" Width="100%" 
            onpageindexchanging="grdviewDimensions_PageIndexChanging" 
