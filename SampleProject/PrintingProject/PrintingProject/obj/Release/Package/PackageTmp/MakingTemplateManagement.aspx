<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="MakingTemplateManagement.aspx.cs" Inherits="PrintingProject.MakingTemplateManagement" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
       ...
       <table width="100%">
        ...
        <div class="boxgray">
            <table width="100%">
                <tr>
                    ...
                    <td style="width: 100px;">
                        <asp:HyperLink ID="HyperLinkMakingTemplate" runat="server" BackColor="#99CCFF">قالب</asp:HyperLink>
                    </td>
                    <td style="width: 100px;">
        ...
        <table style="padding: 10px">
            ...
            <tr>
                ...
                <td>
                    <telerik:RadComboBox MarkFirstMatch="True" runat="server" ID="cmbLetterPressDevice"
                        DataTextField="Name" DataValueField="Id" Skin="Office2010Blue">
                    </telerik:RadComboBox>
                    <asp:RequiredFieldValidator runat="server" ErrorMessage="*" ControlToValidate="cmbLetterPressDevice"
                        ValidationGroup="insert" ForeColor="#FF3300"></asp:RequiredFieldValidator>
                </td>
            </tr>
            <tr>
                ...
                <td>
                    <telerik:RadComboBox MarkFirstMatch="True" runat="server" ID="cmbTemplateMaterialType"
                        DataTextField="Name" DataValueField="Id" Skin="Office2010Blue">
                    </telerik:RadComboBox>
                    <asp:RequiredFieldValidator runat="server" ErrorMessage="*" ControlToValidate="cmbTemplateMaterialType"
                        ValidationGroup="insert" ForeColor="#FF3300"></asp:RequiredFieldValidator>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td>
                    <telerik:RadNumericTextBox runat="server" ID="txtCount" MinValue="0" Skin="Web20">
            ...
            <tr>
                ...
                <td>
                    <telerik:RadComboBox MarkFirstMatch="True" runat="server" ID="cmbBladeType" DataTextField="Name"
                        DataValueField="Id" Skin="Office2010Blue">
                    </telerik:RadComboBox>
                    <asp:RequiredFieldValidator runat="server" ErrorMessage="*" ControlToValidate="cmbBladeType"
                        ValidationGroup="insert" ForeColor="#FF3300"></asp:RequiredFieldValidator>
                </td>
            </tr>
            <tr>
                ...
                <td>
                    <telerik:RadTextBox runat="server" Skin="Web20" ID="txtPorferazhModel">
                    </telerik:RadTextBox>
                </td>
            </tr>
            <tr>
    ...
    <div class="sectioncontent">
        <asp:GridView ID="grdviewMakingTemplate" runat="server" AutoGenerateColumns="False"
            ShowHeaderWhenEmpty="True" EmptyDataText="رکوردی موجود نیست." CellPadding="4"
            AllowPaging="True" PageSize="10" Width="100%" OnPageIndexChanging="grdviewMakingTemplate_PageIndexChanging"
            ...
            <Columns>
                ...
                <asp:BoundField DataField="LetterPressDeviceName" HeaderText="نوع دستگاه دایکات">
                    <HeaderStyle HorizontalAlign="Right" />
                    <ItemStyle HorizontalAlign="Right" />
                </asp:BoundField>
                ...
                <asp:TemplateField>
                    <ItemTemplate>
                        <asp:HyperLink ImageUrl="Images/printer.png" ID="HyperLink1" runat="server" Target="_blank"
                            NavigateUrl='<%# "PrintPreviewPage.aspx?MakingTemplateId=" + Eval("Id") %>'></asp:HyperLink>
                    </ItemTemplate>
                    <ItemStyle HorizontalAlign="Center" Width="80px" />
                </asp:TemplateField>
            </Columns>
