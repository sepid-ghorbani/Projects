<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="VeneerTypesManagement.aspx.cs" Inherits="PrintingProject.VeneerTypesManagement" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="sectioncontent">
        <table>
            <tr>
                <td>
                    <img src="Images/menu/Submenu/promotion.png" />
                </td>
                <td>
                    <br />
                    اضافه کردن نوع روکش
    ...
    <div class="sectioncontent">
        <asp:GridView ID="grdviewVeneerTypes" runat="server" AutoGenerateColumns="False"  ShowHeaderWhenEmpty="True" EmptyDataText="رکوردی موجود نیست."
            CellPadding="4" AllowPaging="True" PageSize="10" Width="100%" 
            onpageindexchanging="grdviewVeneerTypes_PageIndexChanging" 
