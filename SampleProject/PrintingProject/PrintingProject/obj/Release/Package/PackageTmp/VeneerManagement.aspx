<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="VeneerManagement.aspx.cs" Inherits="PrintingProject.VeneerManagement" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
       ...
       <div class="boxgray">
            <table width="100%">
                <tr>
                    ...
                    <td style="width: 100px;">
                        <asp:HyperLink ID="HyperLinkVeneer" runat="server" BackColor="#99CCFF">روکش</asp:HyperLink>
                    </td>
                    <td style="width: 100px;">
        ...
        <table style="padding: 10px">
            ...
            <tr>
                ...
                <td>
                    <telerik:RadComboBox MarkFirstMatch="True" runat="server" ID="cmbVeneerType" DataTextField="Name"
                        DataValueField="Id" Skin="Office2010Blue">
                    </telerik:RadComboBox>
                    <asp:RequiredFieldValidator runat="server" ErrorMessage="*" ControlToValidate="cmbVeneerType"
                        ValidationGroup="insert" ForeColor="#FF3300"></asp:RequiredFieldValidator>
                </td>
            </tr>
            <tr>
                ...
                <td>
                    <telerik:RadComboBox MarkFirstMatch="True" runat="server" ID="cmbModel" Skin="Office2010Blue">
                        <Items>
                            <telerik:RadComboBoxItem runat="server" Text="یک رو" Value="1" />
                            <telerik:RadComboBoxItem runat="server" Text="دو رو" Value="2" />
                        </Items>
                    </telerik:RadComboBox>
                </td>
            </tr>
    ...
    <div class="sectioncontent">
        <asp:GridView ID="grdviewVeneer" runat="server" AutoGenerateColumns="False" ShowHeaderWhenEmpty="True"
            EmptyDataText="رکوردی موجود نیست." CellPadding="4" AllowPaging="True" PageSize="10"
            Width="100%" OnPageIndexChanging="grdviewVeneer_PageIndexChanging" GridLines="None"
            ForeColor="#333333">
            <AlternatingRowStyle BackColor="White" />
            <Columns>
                <asp:BoundField DataField="OrderSeries" HeaderText="سری سفارش">
                ...
                <asp:BoundField DataField="VeneerTypeName" HeaderText="نوع روکش">
                    <HeaderStyle HorizontalAlign="Right" />
                    <ItemStyle HorizontalAlign="Right" />
                </asp:BoundField>
                ...
                <asp:TemplateField>
                    <ItemTemplate>
                        <asp:HyperLink ImageUrl="Images/printer.png" ID="HyperLink1" runat="server" Target="_blank"
                            NavigateUrl='<%# "PrintPreviewPage.aspx?VeneerId=" + Eval("Id") %>'></asp:HyperLink>
                    </ItemTemplate>
                    <ItemStyle HorizontalAlign="Center" Width="80px" />
                </asp:TemplateField>
            </Columns>
