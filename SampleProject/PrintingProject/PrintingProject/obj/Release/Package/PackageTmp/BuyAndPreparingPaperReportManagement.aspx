<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="BuyAndPreparingPaperReportManagement.aspx.cs" Inherits="PrintingProject.BuyAndPreparingPaperReportManagement" %>
        ...
        <div class="boxReport">
            ...
            <table style="width: 100%">
                 <tr>
                    ...
                    <td>
                        <telerik:RadComboBox ID="cmbOrderReceiver" MarkFirstMatch="True" runat="server" Skin="Office2010Blue" Width="250px"
                ...
                <tr>
                    ...
                    <td>
                        <telerik:RadComboBox ID="cmbDestination" MarkFirstMatch="True" runat="server" Skin="Office2010Blue" Width="250px"
                            DataTextField="Name" DataValueField="Id">
                        </telerik:RadComboBox>
                    </td>
                </tr>
