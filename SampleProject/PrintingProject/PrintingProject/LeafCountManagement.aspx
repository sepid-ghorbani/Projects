<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="LeafCountManagement.aspx.cs" Inherits="PrintingProject.LeafCountManagement" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="sectioncontent">
        <table>
            <tr>
                <td>
                    <img src="Images/menu/Submenu/pages.png" />
                </td>
                <td>
                    <br />
                    اضافه کردن تعداد برگ
                </td>
            </tr>
        </table>
        <table style="padding: 10px">
            <tr>
                ...
                <td>
                    <telerik:RadNumericTextBox runat="server" ID="txtName" MinValue="0" Skin="Web20">
    ...
    <div class="sectioncontent">
        <asp:GridView ID="grdviewLeafCount" runat="server" AutoGenerateColumns="False" ShowHeaderWhenEmpty="True"
            EmptyDataText="رکوردی موجود نیست." CellPadding="4" AllowPaging="True" PageSize="10"
            Width="100%" OnPageIndexChanging="grdviewLeafCount_PageIndexChanging" GridLines="None"
            ForeColor="#333333">
