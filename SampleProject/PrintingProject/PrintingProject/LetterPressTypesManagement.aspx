<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="LetterPressTypesManagement.aspx.cs" Inherits="PrintingProject.LetterPressTypesManagement" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="sectioncontent">
        <table>
            <tr>
                <td>
                    <img src="Images/menu/Submenu/page_process.png" />
                </td>
                <td>
                    <br />
                    اضافه کردن نوع دایکات 
                </td>
            </tr>
        </table>
    ...
    <div class="sectioncontent">
        <asp:GridView ID="grdviewLetterPressTypes" runat="server" AutoGenerateColumns="False"  ShowHeaderWhenEmpty="True" EmptyDataText="رکوردی موجود نیست."
            CellPadding="4" AllowPaging="True" PageSize="10" Width="100%" 
            onpageindexchanging="grdviewLetterPressTypes_PageIndexChanging" 
