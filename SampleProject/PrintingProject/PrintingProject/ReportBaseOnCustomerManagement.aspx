<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="ReportBaseOnCustomerManagement.aspx.cs" Inherits="PrintingProject.ReportBaseOnCustomerManagement" %>
        ...
        <div class="boxReport">
            <table>
                <tr>
                    ...
                    <td>
                        موارد زیر را جهت گزارش گیری انتخاب نمایید:
                    </td>
                </tr>
            </table>
                    ...
                    <td>
                        <telerik:RadComboBox ID="comboInvoiceStatus" MarkFirstMatch="True" runat="server" Width="250px"
                            ...
                            <Items>
                                ...
                                <telerik:RadComboBoxItem runat="server" Text="صادر شده" Value="صادر شده" />
                                <telerik:RadComboBoxItem runat="server" Text="صادر نشده" Value="صادر نشده" />
                                <telerik:RadComboBoxItem runat="server" Text="ندارد" Value="ندارد" />
                            </Items>
                        </telerik:RadComboBox>
                    </td>
                </tr>
