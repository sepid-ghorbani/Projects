<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="PrintTypesManagement.aspx.cs" Inherits="PrintingProject.PrintTypesManagement" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="sectioncontent">
        <table>
            <tr>
                <td>
                    <img src="Images/menu/Submenu/printer_accept.png" />
                </td>
                <td>
                    <br />
                    اضافه کردن نوع چاپ
    ...
    <div class="sectioncontent">
        <asp:GridView ID="grdviewPrintTypes" runat="server" AutoGenerateColumns="False"  ShowHeaderWhenEmpty="True" EmptyDataText="رکوردی موجود نیست."
            CellPadding="4" AllowPaging="True" PageSize="10" Width="100%" 
            onpageindexchanging="grdviewPrintTypes_PageIndexChanging" 
