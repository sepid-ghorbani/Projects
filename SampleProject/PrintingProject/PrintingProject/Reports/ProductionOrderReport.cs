namespace PrintingProject.Reports
{
    ...
    /// </summary>
    public partial class ProductionOrderReport : Telerik.Reporting.Report
    {
        ...
        private void ProductionOrderReport_NeedDataSource(object sender, EventArgs e)
        {
            var report = sender as Telerik.Reporting.Processing.Report;
            int id = Convert.ToInt32(ReportParameters["Id"].Value);
            var dt = _productionOrderFactory.ReportById(id);
