...
{
	public class PreparingPaper: BusinessObjectBase
	{

		#region InnerClass
		public enum PreparingPaperFields
		{
			Id,
			JobId,
			FromInstituteId,
		...
		public int  ToInstituteId
		{
			 get { return _toInstituteId; }
			 set
			 {
				 if (_toInstituteId != value)
				 {
					_toInstituteId = value;
					 PropertyHasChanged("ToInstituteId");
				 }
			 }
		}
		...
		internal override void AddValidationRules()
		{
			...
			ValidationRules.AddRules(new Validation.ValidateRuleNotNull("ToInstituteId", "ToInstituteId"));
