<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="MaterialTypeGramazhManagement.aspx.cs" Inherits="PrintingProject.MaterialTypeGramazhManagement" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="sectioncontent">
        <table>
            <tr>
                <td>
                    <img src="Images/menu/Submenu/process_info.png" />
                </td>
                <td>
                    <br />
                    اضافه کردن گرماژ جنس مصرفی
                </td>
            </tr>
        </table>
    ...
    <div class="sectionheader">
        ...
        <div style="float: right; padding-top: 5px; height: 14px;">
            لیست گرماژ جنس مصرفی
        </div>
        <div style="float: left">
            <asp:Image ID="Image2" runat="server" ImageUrl="Images/box_29.png" /></div>
    </div>
    <div class="sectioncontent">
        <asp:GridView ID="grdviewMaterialTypeGramazh" runat="server" AutoGenerateColumns="False"  ShowHeaderWhenEmpty="True" EmptyDataText="رکوردی موجود نیست."
            CellPadding="4" AllowPaging="True" PageSize="10" Width="100%" 
            onpageindexchanging="grdviewMaterialTypeGramazh_PageIndexChanging" 
