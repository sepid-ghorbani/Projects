<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="DeliveryReceiversManagement.aspx.cs" Inherits="PrintingProject.DeliveryReceiversManagement" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="sectioncontent">
        <asp:GridView ID="grdviewDeliveryReceivers" runat="server" AutoGenerateColumns="False" ShowHeaderWhenEmpty="True"
            EmptyDataText="رکوردی موجود نیست." CellPadding="4" AllowPaging="True" PageSize="10"
            Width="100%" OnPageIndexChanging="grdviewDeliveryReceivers_PageIndexChanging" GridLines="None"
            ForeColor="#333333">
