<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="BladeTypeManagement.aspx.cs" Inherits="PrintingProject.BladeTypeManagement" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="sectioncontent">
        <table>
            <tr>
                <td>
                    <img src="Images/menu/Submenu/cut_from_page.png" />
                </td>
                <td>
                    <br />
                    اضافه کردن نوع تیغ و خط تا
                </td>
            </tr>
        </table>
    ...
    <div class="sectionheader">
        ...
        <div style="float: right; padding-top: 5px; height: 14px;">
            لیست نوع تیغ و خط تا
        </div>
        <div style="float: left">
            <asp:Image ID="Image2" runat="server" ImageUrl="Images/box_29.png" /></div>
    </div>
    <div class="sectioncontent">
        <asp:GridView ID="grdviewBladeType" runat="server" AutoGenerateColumns="False"  ShowHeaderWhenEmpty="True" EmptyDataText="رکوردی موجود نیست."
            CellPadding="4" AllowPaging="True" PageSize="10" Width="100%" 
            onpageindexchanging="grdviewBladeType_PageIndexChanging" 
