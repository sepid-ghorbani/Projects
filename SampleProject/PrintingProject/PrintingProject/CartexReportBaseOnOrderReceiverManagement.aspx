<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="CartexReportBaseOnOrderReceiverManagement.aspx.cs" Inherits="PrintingProject.CartexReportBaseOnOrderReceiverManagement" %>
        ...
        <div class="boxReport">
            ...
            <table style="width: 100%">
                <tr>
                    ...
                    <td>
                        <telerik:RadComboBox ID="comboLevelName" MarkFirstMatch="True" runat="server" Skin="Office2010Blue"
                            DataTextField="Name" DataValueField="Id" Width="250px">
                            <Items>
                                <telerik:RadComboBoxItem runat="server" Text="همه موارد" Value="0" />
                                <telerik:RadComboBoxItem runat="server" Text="موجودی اولیه" Value="موجودی اولیه" />
                                <telerik:RadComboBoxItem runat="server" Text="سفارش تولید" Value="سفارش تولید" />
                                <telerik:RadComboBoxItem runat="server" Text="تحویل محصول" Value="تحویل محصول" />
                            </Items>
                        </telerik:RadComboBox>
                    </td>
                ...
                <tr>
                    ...
                    <td>
                     ...
                     <td>شماره رسید</td>
                    <td>
                        <telerik:RadTextBox runat="server" Skin="Web20" ID="txtReceiptNum" Width="250px">
                        </telerik:RadTextBox>
                    </td>
                ...
                <tr>
                    ...
                    <td>شماره فاکتور ورودی
                    </td>
                    <td>

                        <telerik:RadTextBox runat="server" Skin="Web20" ID="txtInputInvoiceNum" Width="250px">
                        </telerik:RadTextBox>
                    </td>
                </tr>
                <tr>
                    ...
                    <td>
                        <telerik:RadComboBox ID="comboJobName" MarkFirstMatch="True" runat="server" Skin="Office2010Blue" Width="250px" AllowCustomText="True"
                            DataTextField="JobName" DataValueField="JobCode" OnSelectedIndexChanged="comboJobName_SelectedIndexChanged" AutoPostBack="True">
                        </telerik:RadComboBox>
                    </td>
