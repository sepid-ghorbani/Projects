...
{
    public partial class UsePaperReportManagement : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!Page.IsPostBack)
            {
                ...
                if (!_userPageFactory.HasPermission(PrintingProject.Session.UserId, "UsePaperReportManagement.aspx"))
                {
        ...
        {
            var r = new UsePaperGeneralReport();

            r.ReportParameters["CustomerId"].Value = cmbCustomers.SelectedValue != "0"
            ...
            r.ReportParameters["UseStatus"].Value = cmbUseStatus.SelectedValue != ""
                ? cmbUseStatus.SelectedValue
                : null; ;
